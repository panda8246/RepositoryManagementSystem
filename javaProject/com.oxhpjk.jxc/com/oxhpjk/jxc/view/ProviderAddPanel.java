...
public class ProviderAddPanel extends JPanel implements ActionListener {
	...
	public  ProviderAddPanel() {
		...
		saveBtn.setFont(new Font("黑体", Font.PLAIN, 15));
		saveBtn.addActionListener(this);
		panel_12.add(saveBtn);

		JButton resetBtn = new JButton("重置");
		resetBtn.setFont(new Font("黑体", Font.PLAIN, 15));
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "保存":
			//格式校验
			ProviderInternalFrame.dataCheck(providerNameTf.getText().trim(),
			...
			//将客户信息添加到数据库
			Provider provider = new Provider(id, providerNameTf.getText().trim(), 
