...
public class CustomerEditPanel extends JPanel implements ActionListener{
	...
	public CustomerEditPanel() {
		...
		JLabel label = new JLabel("客户邮编：");
		label.setForeground(new Color(0, 153, 255));
		label.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		JLabel label_1 = new JLabel("客户电话：");
		label_1.setForeground(new Color(0, 153, 255));
		label_1.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		JLabel label_2 = new JLabel("客户传真：");
		label_2.setForeground(new Color(0, 153, 255));
		label_2.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		label_3.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		label_4.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		label_5.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		label_6.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		JLabel label_7 = new JLabel("客户邮箱：");
		label_7.setForeground(new Color(0, 153, 255));
		label_7.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		JLabel label_8 = new JLabel("选择客户：");
		label_8.setForeground(new Color(0, 153, 255));
		label_8.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		updateBtn.setFont(new Font("隶书", Font.PLAIN, 15));
		//给修改按钮绑定点击事件
		updateBtn.addActionListener(this);
		panel_12.add(updateBtn);
		
		JButton deleteBtn = new JButton("删除");
		deleteBtn.setFont(new Font("隶书", Font.PLAIN, 15));
		//给删除按钮绑定点击事件
		...
		lblNewLabel_2.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		lblNewLabel_1.setFont(new Font("隶书", Font.PLAIN, 15));
		...
		lblNewLabel.setFont(new Font("隶书", Font.PLAIN, 15));
	...
	private void selectAction() {
		...
		List<Customer> cust = customerService.findCustomers(c);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "修改":
			...
			//校验
			//格式校验
			CustomerInternalFrame.dataCheck(nameTf.getText().trim(),
			...
			//修改数据			
			boolean result = customerService.updateCustomer(new Customer(id, 
			...
			if(result==true) {
				JOptionPane.showMessageDialog(null, "客户信息修改成功！","提示",JOptionPane.INFORMATION_MESSAGE);
			}else {
				JOptionPane.showMessageDialog(null, "客户信息修改失败！","警告",JOptionPane.WARNING_MESSAGE);
			}
			break;
        case "删除":
			int type = JOptionPane.showConfirmDialog(null, "是否删除当前客户？", "温馨提示", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
			if(type==0) {//删除
				//获取客户编号
				String sid = selectedItem.getId();
				boolean r = customerService.updateCustomer(sid, Constants.DATA_DEL);
				if(r==true) {
					JOptionPane.showMessageDialog(null, "客户信息删除成功！","提示",JOptionPane.INFORMATION_MESSAGE);
					//更新界面
					initComboBox();
				}else {
					JOptionPane.showMessageDialog(null, "客户信息删除失败！","警告",JOptionPane.WARNING_MESSAGE);
				}
			}
			break;
